...
#define MATCH_CONVSETBASE 0xb
#define MASK_CONVSETBASE 0xfe00707f
#define MATCH_CONVSETSIZE 0x100b
#define MASK_CONVSETSIZE 0xfe00707f
#define MATCH_CONVRUN 0x200b
#define MASK_CONVRUN 0xfe00707f
...
/*CUSTOM CONVOLUTION INSTRUCTIONS*/
DECLARE_INSN(convsetbase, MATCH_CONVSETBASE, MASK_CONVSETBASE)
DECLARE_INSN(convsetsize, MATCH_CONVSETSIZE, MASK_CONVSETSIZE) 
DECLARE_INSN(convrun, MATCH_CONVRUN, MASK_CONVRUN)
